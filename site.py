...
model_path = 'C:\Users\amanp\OneDrive\Documents\Github\Hybrid Model OF VGG-19 & ResNet-50\best_model.h5'
...
DOCTOR_DATABASE = {
    'Cardiologist': [
        ...
        {'name': 'Dr. Marcus Thorne', 'location': 'Heartbeat Center, Uptown', 'rating': 4.9, 'fee': 1800},
    ],
    'Dermatologist': [
        {'name': 'Dr. Lena Petrova', 'location': 'Clear Skin Institute, South End', 'rating': 4.7, 'fee': 1200},
        {'name': 'Dr. Samuel Cho', 'location': 'The Dermatology Group, West End', 'rating': 4.6, 'fee': 1100},
    ],
    'Orthopedic Surgeon': [
        {'name': 'Dr. Isabella Rossi', 'location': 'Joint & Bone Specialists, North Park', 'rating': 4.9, 'fee': 2000},
        {'name': 'Dr. Kenji Tanaka', 'location': 'Active Life Orthopedics, Eastside', 'rating': 4.8, 'fee': 1900},
    ],
    'General Physician': [
        {'name': 'Dr. Alice Williams', 'location': 'Community Health Center', 'rating': 4.5, 'fee': 800},
        {'name': 'Dr. Ben Carter', 'location': 'Family Practice Associates', 'rating': 4.7, 'fee': 900},
    ],
    'Neurologist': [
        {'name': 'Dr. Omar Hassan', 'location': 'Mind & Brain Clinic, Central City', 'rating': 4.9, 'fee': 2200},
        {'name': 'Dr. Sofia Chen', 'location': 'NeuroHealth Institute, Medical District', 'rating': 4.8, 'fee': 2100},
    ],
    'Dentist': [
        {'name': 'Dr. Clara Santos', 'location': 'Bright Smile Dental, City Center', 'rating': 4.9, 'fee': 1000},
        {'name': 'Dr. James Kwon', 'location': 'Downtown Dental Care, Metro Area', 'rating': 4.7, 'fee': 950},
    ]
}
...
if page == "Home":
    ...
    st.markdown(
        ...
        - **Appointment Booking:** Schedule your consultation seamlessly.
...
# ------------------------------------
    ...
    with st.form("booking_form"):
        ...
        st.info(f"Consultation Fee: ₹{consultation_fee} (Pay at clinic)")

        st.subheader("Step 2: Provide Your Details")
